...
_RULESETS = {
    "pulleyblank_core_v4": "wenyan_scorer.rulesets.pulleyblank_core_v4",
    "vernacular_v1": "wenyan_scorer.rulesets.vernacular_v1",
    "idu_experimental": "wenyan_scorer.rulesets.idu_experimental",
}
