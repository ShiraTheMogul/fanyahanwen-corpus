...
# Keywords identifying a Wikisource copyright footer. My corpus began as
# Wikisource scrapes and the footer sometimes came along with the text. It is not
# part of the work, and on a short document it dominates: 上帝爲我避難所 is 五言
...
#: Licence removal drops whole SENTENCES containing a keyword. Matching a window
#: around the keyword is not safe: a leading `[^\n]{0,80}` to catch the date
#: prefix swallowed the 80 characters of poem in front of the footer.
