...
#: interpunct, not a kana: Chinese, Japanese and Korean texts alike use it to
#: separate the syllables of a transliterated foreign name, and 心理新説序
#: (1880s 漢文) uses it exactly that way in 費希的・設林・歇傑爾 — Fichte,
#: Schelling, Hegel. Stripping it destroyed the only context that identifies the
#: 的 in 費希的 as a phonogram rather than a vernacular linker, and the scorer
#: then read a Meiji Literary Chinese essay as having vernacular grammar.
