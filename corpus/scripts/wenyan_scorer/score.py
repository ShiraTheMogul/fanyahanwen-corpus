...
#
# The separation is in the SHARE: modern Mandarin has a perfectly respectable literary rate (125) 
# because 之, 者, 以, 其 and 而 all survive in written Mandarin Chinese. What it does not have is 
# a low proportion of vernacular evidence. So the primary test is the share, and the absolute rates
# only guard against deciding on a handful of hits.
...
# it as a real posterior until `wenyan_syntax calibrate` has run.
