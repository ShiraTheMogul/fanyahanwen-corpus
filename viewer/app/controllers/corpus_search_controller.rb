...
class CorpusSearchController < ApplicationController
  ...
  def prepared_status_payload(prepared_search)
...

    {
      ...
      started_at: prepared_search.payload["started_at"],
      completed_at: prepared_search.payload["completed_at"],
      duration_seconds: prepared_search.payload["duration_seconds"],
